...
/**
 * Used to bind a impl which decorated with several decorators:
 * impl <- decorator1 <- ... <- decoratorN
 * you can bind it by:
 * impl(xxx).decoratedWith(decorator1, ..., decoratorN);
 * or you can:
...
public abstract class ChainOf<T> extends ChainModule<T> {
    ...
    protected static final class BindImplClause<T> {
        ...
        public final void decoratedWith(DecoratorFactory<T> implDecoratorFactory,
        ...
        public final void decoratedWith(Class<? extends T> implDecoratorClass,
