...
/**
 * Used to control how to create a decorator.
 * Can be used to partipate building a chain, as input.
 * Also could be result bound by DecoratorFactoryOf modules, as output.
 *
