// $LastChangedRevision: 5810 $ DO NOT EDIT.  Make changes to EOSacado.java instead.
...
public abstract class _EOSacado extends  EOGenericRecord {
  ...
  private static Logger LOG = Logger.getLogger(_EOSacado.class);
  ...
  public void setBairro(String value) {
    if (_EOSacado.LOG.isDebugEnabled()) {
    	_EOSacado.LOG.debug( "updating bairro from " + bairro() + " to " + value);
    }
  ...
  public void setCep(String value) {
    if (_EOSacado.LOG.isDebugEnabled()) {
    	_EOSacado.LOG.debug( "updating cep from " + cep() + " to " + value);
    }
  ...
  public void setCidade(String value) {
    if (_EOSacado.LOG.isDebugEnabled()) {
    	_EOSacado.LOG.debug( "updating cidade from " + cidade() + " to " + value);
    }
  ...
  public void setCpf(String value) {
    if (_EOSacado.LOG.isDebugEnabled()) {
    	_EOSacado.LOG.debug( "updating cpf from " + cpf() + " to " + value);
    }
  ...
  public void setEndereco(String value) {
    if (_EOSacado.LOG.isDebugEnabled()) {
    	_EOSacado.LOG.debug( "updating endereco from " + endereco() + " to " + value);
    }
  ...
  public void setNome(String value) {
    if (_EOSacado.LOG.isDebugEnabled()) {
    	_EOSacado.LOG.debug( "updating nome from " + nome() + " to " + value);
    }
  ...
  public void setUf(String value) {
    if (_EOSacado.LOG.isDebugEnabled()) {
    	_EOSacado.LOG.debug( "updating uf from " + uf() + " to " + value);
    }
