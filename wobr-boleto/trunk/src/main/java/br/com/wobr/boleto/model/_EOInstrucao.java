// $LastChangedRevision: 5810 $ DO NOT EDIT.  Make changes to EOInstrucao.java instead.
...
public abstract class _EOInstrucao extends br.com.wobr.boleto.model.AbstractInformacao {
  ...
  private static Logger LOG = Logger.getLogger(_EOInstrucao.class);
