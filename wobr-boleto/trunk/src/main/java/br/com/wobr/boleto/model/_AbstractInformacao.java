// $LastChangedRevision: 5810 $ DO NOT EDIT.  Make changes to AbstractInformacao.java instead.
...
public abstract class _AbstractInformacao extends  EOGenericRecord {
  ...
  private static Logger LOG = Logger.getLogger(_AbstractInformacao.class);
  ...
  public void setTipo(String value) {
    if (_AbstractInformacao.LOG.isDebugEnabled()) {
    	_AbstractInformacao.LOG.debug( "updating tipo from " + tipo() + " to " + value);
    }
  ...
  public void setValor(String value) {
    if (_AbstractInformacao.LOG.isDebugEnabled()) {
    	_AbstractInformacao.LOG.debug( "updating valor from " + valor() + " to " + value);
    }
