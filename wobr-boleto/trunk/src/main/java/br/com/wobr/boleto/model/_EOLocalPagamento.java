// $LastChangedRevision: 5810 $ DO NOT EDIT.  Make changes to EOLocalPagamento.java instead.
...
public abstract class _EOLocalPagamento extends br.com.wobr.boleto.model.AbstractInformacao {
  ...
  private static Logger LOG = Logger.getLogger(_EOLocalPagamento.class);
