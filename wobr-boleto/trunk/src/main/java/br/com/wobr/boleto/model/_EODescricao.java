// $LastChangedRevision: 5810 $ DO NOT EDIT.  Make changes to EODescricao.java instead.
...
public abstract class _EODescricao extends br.com.wobr.boleto.model.AbstractInformacao {
  ...
  private static Logger LOG = Logger.getLogger(_EODescricao.class);
